...
<div id="app">
    <div id="gantt-header" class="h-12 p-2 flex items-center">
        ...
        <h1 class="text-sm font-bold">{{$date}}のシフト</h1>
        <teleport to="#form">
            <div class="base" v-show="show">
                ...
                <div class="content" v-show="show">
                    ...
                    <div class="my-4">
                        <label class="text-xs">ユーザー名: @{{form.name}}</label>
                    </div>
                    <div class="my-4">
    ...
    <div id="gantt-content" class="flex">
        <div id="gantt-task" class="border-r">
            <div id="gantt-task-title" class="flex items-center bg-green-600 text-white h-20" ref="task">
                <div class="border-t border-b flex items-center justify-center font-bold text-xs h-full" :style="`width:300px`">名前</div>
            </div>
...
<script>
    ...
    const app = Vue.createApp({
        ...
        mounted() {
            ...
            console.log(JSON.parse((@json($users))))
        },
        computed: {
            calendarViewWidth() {
